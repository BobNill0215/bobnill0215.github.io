    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <header className="mb-8">
          ...
          <span className="bg-orange-600 text-white text-xs px-2 py-1 rounded">配件推荐</span>
          <h1 className="text-3xl font-bold mt-4 mb-2">运动相机配件套装推荐</h1>
          <p className="text-gray-600">自拍杆、防水壳、胸前固定带等配件</p>
