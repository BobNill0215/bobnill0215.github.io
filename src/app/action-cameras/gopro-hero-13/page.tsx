    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <header className="mb-8">
          ...
          <span className="bg-orange-600 text-white text-xs px-2 py-1 rounded">新品资讯</span>
          <h1 className="text-3xl font-bold mt-4 mb-2">GoPro Hero 13 Black 新品发布</h1>
          <p className="text-gray-600">5.3K/60fps，HB系列镜头，续航升级</p>
