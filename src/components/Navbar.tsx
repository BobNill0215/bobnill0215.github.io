...
const navCategories = [
  {
    ...
    href: '/cameras',
    submenu: [
      { name: '索尼 Sony', href: '/cameras?brand=sony' },
      { name: '佳能 Canon', href: '/cameras?brand=canon' },
      { name: '尼康 Nikon', href: '/cameras?brand=nikon' },
      { name: '富士 Fujifilm', href: '/cameras?brand=fujifilm' },
  ...
  },
  {
    ...
    submenu: [
      { name: 'iPhone', href: '/smartphone-cameras?brand=apple' },
      { name: '三星 Samsung', href: '/smartphone-cameras?brand=samsung' },
      { name: '小米 Xiaomi', href: '/smartphone-cameras?brand=xiaomi' },
      { name: '华为 Huawei', href: '/smartphone-cameras?brand=huawei' },
  ...
  },
  {
    ...
    href: '/action-cameras',
    submenu: [
      { name: 'GoPro', href: '/action-cameras?brand=gopro' },
      { name: '大疆 DJI', href: '/action-cameras?brand=dji' },
      { name: 'Insta360', href: '/action-cameras?brand=insta360' },
  ...
  },
  {
    ...
    submenu: [
      { name: '萤石 EZVIZ', href: '/security-cameras?brand=ezviz' },
      { name: '小米 Xiaomi', href: '/security-cameras?brand=xiaomi' },
      { name: '360', href: '/security-cameras?brand=360' },
  ...
  },
  {
    ...
    href: '/guides',
    submenu: [
      { name: '最佳微单', href: '/guides?type=mirrorless' },
      { name: '最佳运动相机', href: '/guides?type=action' },
      { name: '最佳拍照手机', href: '/guides?type=phone' },
      { name: '预算指南', href: '/guides?type=budget' },
    ],
  },
];
